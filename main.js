...
var _Soreine$water_writing$Constants$tab = 9;
var _Soreine$water_writing$Constants$uparrow = 38;
var _Soreine$water_writing$Constants$leftarrow = 37;
var _Soreine$water_writing$Constants$enter = 13;
...
var _Soreine$water_writing$Main$onKeys = F2(
	function (keyCodes, onKey) {
		var filterKey = function (code) {
			return A2(_elm_lang$core$List$member, code, keyCodes) ? _elm_lang$core$Json_Decode$succeed(
				onKey(code)) : _elm_lang$core$Json_Decode$fail('ignored input');
		};
...
var _Soreine$water_writing$Main$toStringList = function (str) {
	return A2(
		_elm_lang$core$List$map,
...
var _Soreine$water_writing$Main$newInput = F2(
	function (model, newText) {
		var newChars = _Soreine$water_writing$Main$toStringList(newText);
		var sizeDiff = _elm_lang$core$List$length(newChars) - _elm_lang$core$List$length(model.strokes);
		var paddedStrokes = A2(
			_elm_lang$core$Basics_ops['++'],
			model.strokes,
			A2(
				_elm_lang$core$List$repeat,
				sizeDiff,
				A2(_Soreine$water_writing$Main$Dated, model.now, '')));
		var updatedStrokes = A3(
			_elm_lang$core$List$map2,
			_Soreine$water_writing$Main$updateStroke(model.now),
			paddedStrokes,
			newChars);
...
var _Soreine$water_writing$Main$focusInput = A2(
	...
	function (_p6) {
		return A2(
			...
			_Soreine$water_writing$Main$logError(_p6));
	},
	...
	function (msg, model) {
		...
		switch (_p7.ctor) {
			case 'TypeText':
				return {
					ctor: '_Tuple2',
					_0: A2(_Soreine$water_writing$Main$newInput, model, _p7._0),
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(
								_Soreine$water_writing$Main$onKeys,
								{
									ctor: '::',
									_0: _Soreine$water_writing$Constants$uparrow,
									_1: {
										ctor: '::',
										_0: _Soreine$water_writing$Constants$leftarrow,
										_1: {
											ctor: '::',
											_0: _Soreine$water_writing$Constants$tab,
											_1: {ctor: '[]'}
										}
									}
								},
...
var _Soreine$water_writing$Main$view = function (_p8) {
	var _p9 = _p8;
	var _p12 = _p9.strokes;
	...
	var written = A2(
		_elm_lang$core$List$map,
		_Soreine$water_writing$Main$renderStroke(_p9.now),
		_p12);
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _Soreine$water_writing$Main$hiddenInput(strokesToText),
				_1: {ctor: '[]'}
			}
		});
};
