...
var _Soreine$water_writing$Main$decodeClickLocation = A3(
	...
	A3(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$int)));
var _Soreine$water_writing$Main$stylePosition = function (_p0) {
	var _p1 = _p0;
...
var _Soreine$water_writing$Main$fadingText = F2(
	function (now, dated) {
		var fadingDelay = 3 * _elm_lang$core$Time$second;
		var age = now - dated.time;
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(dated.value),
				_1: {ctor: '[]'}
			});
	});
...
var _Soreine$water_writing$Main$model = {
	location: {ctor: '_Tuple2', _0: 0, _1: 0},
	currentLine: '',
	lines: {ctor: '[]'},
	now: 0
};
...
var _Soreine$water_writing$Main$Model = F4(
	function (a, b, c, d) {
		return {location: a, currentLine: b, lines: c, now: d};
	});
			...
			case 'ClickAt':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							location: {ctor: '_Tuple2', _0: _p2._0._0, _1: _p2._0._1}
						}),
					_1: _Soreine$water_writing$Main$focusInput
				};
			case 'TypeText':
				return {
					ctor: '_Tuple2',
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							lines: A2(
								...
								{
									ctor: '::',
									_0: {time: model.now, value: model.currentLine},
									_1: {ctor: '[]'}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _Soreine$water_writing$Main$view = function (model) {
	var written = A2(
		...
		A2(
			_elm_lang$core$List$map,
			_Soreine$water_writing$Main$fadingText(model.now),
			A2(
				_elm_lang$core$Basics_ops['++'],
				model.lines,
				{
		...
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html_Events$on,
					'click',
					A2(_elm_lang$core$Json_Decode$map, _Soreine$water_writing$Main$ClickAt, _Soreine$water_writing$Main$decodeClickLocation)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$span,
				{
					...
					_1: {
						ctor: '::',
						_0: _Soreine$water_writing$Main$stylePosition(model.location),
						_1: {ctor: '[]'}
					}
				},
				A2(
